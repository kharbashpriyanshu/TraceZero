...
from app_trace_cleaner.registry.registry_reader import RegistryReader
from app_trace_cleaner.registry.package_managers import PackageManagerDetector
from app_trace_cleaner.scanner.file_scanner import FileScanner
...
class ScanEngine:
    ...
    def _run_scan(self):
        ...
        try:
            ...
            file_results = self._file_scanner.scan()
