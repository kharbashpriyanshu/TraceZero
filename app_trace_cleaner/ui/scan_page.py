...
from app_trace_cleaner.utils.helpers import format_size, truncate_path
from app_trace_cleaner.utils.constants import RISK_COLORS, COLOR_ACCENT
from app_trace_cleaner.ui.styles import CATEGORY_ICONS
...
RISK_CELL_STYLE = {
    "Safe":   ("●  Safe",   "#0d3e22", "#3fb950", "#1a7f37"),
    "Review": ("●  Review", "#3d2a00", "#e3b341", "#9e6a03"),
    "Risky":  ("●  Risky",  "#3d0c0c", "#f85149", "#b91c1c"),
}
...
class ScanPage(QWidget):
    ...
    def _build_ui(self):
        ...
        page_title.setStyleSheet("font-size: 20px; font-weight: 800; color: #e6edf3; background: transparent;")
        t_col.addWidget(page_title)
        self.subtitle = QLabel("Ready — press Start Scan to begin")
        self.subtitle.setStyleSheet("font-size: 11px; color: #8b949e; background: transparent;")
        ...
        self.prog_strip.setFixedHeight(48)
        self.prog_strip.setStyleSheet("QFrame { background: #161b22; border-bottom: 1px solid #21262d; }")
        ...
        self.status_lbl.setStyleSheet("font-size: 12px; color: #8b949e; background: transparent;")
        ...
        self.count_lbl.setStyleSheet(f"font-size: 12px; color: {COLOR_ACCENT}; font-weight: 700; background: transparent;")
        ...
        self.stats_bar.setStyleSheet("font-size: 11px; color: #8b949e; background: transparent;")
        ...
        self.sel_lbl = QLabel("")
        self.sel_lbl.setStyleSheet("font-size: 12px; color: #8b949e; background: transparent;")
    ...
    def _rebuild_table(self):
        ...
        for item in self._filtered:
            ...
            pi.setToolTip(path)
            pi.setForeground(QBrush(QColor("#c9d1d9")))
            ...
            sz.setForeground(QBrush(QColor("#8b949e")))
            ...
            ai.setForeground(QBrush(QColor("#8b949e")))
            self.table.setItem(row, COL_AGE, ai)

            # ── Risk badge (colored text) ─────────────────────
            ...
            ri.setForeground(QBrush(QColor(RISK_COLORS.get(risk, "#8b949e"))))
            ...
            why.setForeground(QBrush(QColor("#8b949e")))
